...
** DONE Improving my Clojure skills, Apr 15             :code:problem:clash:
:PROPERTIES:
...
** DONE End of my game dev story? Apr 09                      :gamedevstory:
:PROPERTIES:
...
** DONE Sphere packing on a sphere? Circle packing papers, Mar 08 :math:topology:
:PROPERTIES:
...
** DONE Tools for completing a master's thesis, Feb 25  :thesis:tools:emacs:
:PROPERTIES:
...
** DONE Concerning idea debt and investment, Feb 25    :documentation:ideas:
:PROPERTIES:
...
** DONE Regarding problems which can be solved by dynamic programming techniques, Jan 22 :dynprog:recursion:bfs:
:PROPERTIES:
...
** DONE A flawed idea of the halting problem, Mar 16 :programming:computer:science:
:PROPERTIES:
...
** DONE The beginning of Anton's Game Dev Story, Jan 7        :gamedevstory:
:PROPERTIES:
...
** DONE Presentation of game demo, Dec 13                      :game:design:
:PROPERTIES:
...
** DONE Mobile games, Dec 6                                    :game:design:
:PROPERTIES:
...
** DONE The game producer - Game business models, Dec 3        :game:design:
:PROPERTIES:
...
** DONE Dataspelsbranschen: the trade organization, Nov 29     :game:design:
:PROPERTIES:
...
** DONE Short on game physics and animation, Nov 26            :game:design:
:PROPERTIES:
...
** DONE Using a game engine or building your own? Nov 22       :game:design:
:PROPERTIES:
...
** DONE The Sims - a short presentation, Nov 20                :game:design:
:PROPERTIES:
...
** DONE Future of procedural generation of content, Nov 19     :game:design:
:PROPERTIES:
...
** DONE Data-driven approach, Nov 15                           :game:design:
:PROPERTIES:
...
** DONE Software development model, Nov 12                     :game:design:
:PROPERTIES:
...
** DONE Haven and Hearth, Nov 8                                :game:design:
:PROPERTIES:
...
** DONE What type of gamer are you? Nov 5                      :game:design:
:PROPERTIES:
